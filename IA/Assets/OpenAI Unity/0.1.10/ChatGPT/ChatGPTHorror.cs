    ...
    public class ChatGPTHorror : MonoBehaviour
    {
        ...
        */
        ...
        public async void SendReplyMen()
        {
            ...
            {
                if (messagesMen.Count == 0)
                    newMessage.Content = "Escribe un guion de una situacion de terror, Crea un narrador en voz en off y dos personajes llamdos Clara y Charly, termina cada oracion con eset caracter ´´ ";
